    ...
    <div class="row justify-content-center">
        <div class="col-sm-4">
            <div class="card ">
                ...
                <div class="card-header bg-dark text-white text-center"> <h5> REGISTER </h5>  </div>
                <div class="card-body">
                    <form action="{{ route('registervalidate') }}" method="POST">
                        ...
                        <div class="d-flex justify-content-center">
                            <a class="btn btn-default text-center" href="{{ route('login') }}"> Already have an account? Login instead</a>
                        </div>
